namespace BlogSystem.Data.Migrations
{
    ...
    public class DefaultMigrationConfiguration : DbMigrationsConfiguration<ApplicationDbContext>
    {
        ...
        protected void SeedSettings(ApplicationDbContext context)
        {
            ...
            context.Settings.Add(new Setting { Name = "Web Name", Value = "Web Name" });
            context.Settings.Add(new Setting { Name = "Web Url", Value = "Web Url" });
            ...
            context.Settings.Add(new Setting { Name = "MSVirtAcademy HTML Code", Value = "MSVirtAcademy HTML Code" });
            ...
            context.Settings.Add(new Setting { Name = "Center", Value = "Center" });
        }
